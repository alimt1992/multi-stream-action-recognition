...
from pose_train_model import ResearchModels
from pose_train_data import DataSet, get_generators
import time
import os.path
...
def train(saved_model=None,
    ...
    # Get the model.
    pose_cnn = ResearchModels(nb_classes=len(data.classes), image_shape=image_shape, saved_model=saved_model)
