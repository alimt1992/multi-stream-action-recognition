...
def test_1epoch_fuse(
    ...
    # Get the model.
    #two_stream_fuse = ResearchModels(nb_classes=len(data.classes), image_shape=image_shape, saved_model=saved_model,
    ...
    # Evaluate!
    three_stream_fuse.model.fit_generator(generator=val_generator, steps_per_epoch=steps, max_queue_size=1)
